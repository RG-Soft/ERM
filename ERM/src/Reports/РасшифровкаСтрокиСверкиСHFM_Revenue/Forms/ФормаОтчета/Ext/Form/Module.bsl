...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("ДатаДокумента") Тогда
		...
		Если Параметр <> Неопределено Тогда
			...
			НачалоПериода = НачалоМесяца(Параметры.Отбор.ДатаДокумента);
			Параметр.Использование = Истина;
		...
		Если Параметр <> Неопределено Тогда
			...
			КонецПериода = КонецМесяца(Параметры.Отбор.ДатаДокумента);
			Параметр.Использование = Истина;
