...
Функция ПолучитьТекстЗапроса(ГлубинаDSO) Экспорт
	...
	Для ТекУровень = 0 По ГлубинаDSO - 24 Цикл
		...
		МассивРесурсовБиллингаBilling2.Добавить(СтрШаблон("СУММА(Billing.Amount / ВнутренниеКурсыВалютСрезПоследних%1.Курс * ВнутренниеКурсыВалютСрезПоследних%1.Кратность) КАК USDAmount%1", ТекУровеньСтрокой));
