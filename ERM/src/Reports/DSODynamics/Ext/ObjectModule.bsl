...
Процедура ДобавитьРесурсы(ГлубинаDSO)
	...
	Для Смещение = 0 По ГлубинаDSO - 24 Цикл
		...
		ПолеDSO.ПутьКДанным = "DSO_" + Смещение;
		ПолеDSO.Выражение = "rgsРасчетПоказателей.РассчитатьDSO(AR" + СмещениеСтрокой + ", &Период, СУММА(Billing" + Формат(0 + Смещение, "ЧН=0; ЧГ=0") + "_" + СмещениеСтрокой + "), СУММА(Billing" + Формат(1 + Смещение, "ЧГ=0")
