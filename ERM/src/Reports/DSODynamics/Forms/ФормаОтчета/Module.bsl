...
Процедура ДобавитьОтбор(ГлубинаDSO)
	...
	ГруппаAR = ПоляОтбора.Добавить(Тип("ГруппаЭлементовОтбораКомпоновкиДанных"));
	ГруппаAR.ТипГруппы = ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИли;
	ГруппаAR.Представление = "|AR| " + ?(ВключатьГраничноеЗначение, " >= ", " > ") + ПравоеЗначениеОтбораAR;
	ГруппаAR.Использование = ИспользованиеОтбораAR;
	...
	Для Смещение = 0 По ГлубинаDSO - 24 Цикл
		...
		ПолеОтбора = ГруппаAR.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
