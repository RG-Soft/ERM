...
// { RGS AGorlenko 11.09.2017 15:48:23 - для того, чтобы отдельно отображались важные задачи
&НаКлиенте
Процедура ПриОткрытии(Отказ)
	СгруппироватьПоКолонке("Важность");
КонецПроцедуры // } RGS AGorlenko 11.09.2017 15:48:49 - для того, чтобы отдельно отображались важные задачи
