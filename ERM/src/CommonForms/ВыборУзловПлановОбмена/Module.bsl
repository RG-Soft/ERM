////////////////////////////////////////////////////////////////////////////////
// Форма выбора для полей типа "УзелИнформационнойБазы плана обмена".
//  
////////////////////////////////////////////////////////////////////////////////
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НайденныеСтроки = УзлыПлановОбмена.НайтиСтроки(Новый Структура("УзелИнформационнойБазы", ТекущаяСтрока));
...
Процедура Выбрать(Команда)
	...
	Иначе
		...
		Если ТекущиеДанные = Неопределено Тогда
			ПоказатьПредупреждение(, НСтр("ru = 'УзелИнформационнойБазы не выбран.'"));
		Иначе
...
Процедура ДобавитьИспользуемыйПланОбмена(ОбъектМетаданных)
	...
	Если Параметры.ВыбиратьВсеУзлы Тогда
		...
		НоваяСтрока.УзелИнформационнойБазы                    = ПланОбмена;
	...
	Пока Выборка.Следующий() Цикл
		...
		НоваяСтрока.ПланОбмена              = ПланОбмена;
		НоваяСтрока.ПланОбменаПредставление = ОбъектМетаданных.Синоним;
		НоваяСтрока.УзелИнформационнойБазы                    = Выборка.Ссылка;
