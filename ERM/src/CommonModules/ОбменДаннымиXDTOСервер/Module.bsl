...
Процедура ОткрытьФайлВыгрузки(КомпонентыОбмена, ИмяФайлаОбмена = "") Экспорт
	...
	Если КомпонентыОбмена.ЭтоОбменЧерезПланОбмена Тогда
		...
		// { RGS AGorlenko 7/10/2018 4:22:48 PM - поддержка совместимости с прошлыми версиями
		...
		// } RGS AGorlenko 7/10/2018 4:23:05 PM - поддержка совместимости с прошлыми версиями
