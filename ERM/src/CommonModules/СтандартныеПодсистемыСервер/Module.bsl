...
//
// Параметры:
//  ИмяПланаОбмена - Строка, ПланОбменаСсылка - имя плана обмена или ссылка на УзелИнформационнойБазы плана обмена,
...
// Сохраняет ссылку на главный УзелИнформационнойБазы в константе ГлавныйУзел для возможности восстановления.
...
// Обновляет значение константы Главный УзелИнформационнойБазы в узлах АРМ.
//
