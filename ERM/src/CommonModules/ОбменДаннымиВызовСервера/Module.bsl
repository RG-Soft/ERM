...
//
// Параметры:
//     УзелИнформационнойБазы - ПланОбменаСсылка - ссылка на анализируемый УзелИнформационнойБазы плана обмена.
//
// Возвращаемое значение:
...
// Проверяет, является ли главным указанный УзелИнформационнойБазы обмена.
//
// Параметры:
