...
//
// Параметры:
//   НастройкиКД - НастройкиКомпоновкиДанных - Корневой УзелИнформационнойБазы настроек, от которого строится полный путь.
//   ЭлементКД - Произвольный - УзелИнформационнойБазы настроек, к которому строится полный путь.
//
// Возвращаемое значение:
...
//
// Параметры:
//   НастройкиКД - НастройкиКомпоновкиДанных - Корневой УзелИнформационнойБазы настроек, в который вложен искомый элемент.
//   ПолныйПутьКЭлементу - Строка - полный путь к элементу. Может быть получена в функции ПолныйПутьКЭлементу().
//
// Возвращаемое значение:
//   ЭлементКД - Произвольный - Найденный УзелИнформационнойБазы настроек.
//
