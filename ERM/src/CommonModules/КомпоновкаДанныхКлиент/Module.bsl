...
Процедура ОтборОбработатьВыборЗначения(Форма, Элемент, СтандартнаяОбработка, Значение, СписокПараметров, ТипПоля) Экспорт
	...
	//ИначеЕсли ТипЭлемента = РаботаСНСИКлиентСерверПереопределяемый.ТипПодразделения() Тогда
	//	
	//	СтандартнаяОбработка = Ложь;
	//	
	//	ЗначенияОтборов = Новый Структура;
	...
	//	КонецЕсли;
	//	ИмяРеквизитаКонтрагента = РаботаСНСИКлиентСерверПереопределяемый.ПолучитьИмяРеквизитаКонтрагентДоговора();
