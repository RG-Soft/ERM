...
//
//  УзелПроверкиЗапретаЗагрузки  - ПланОбменаСсылка - УзелИнформационнойБазы, для которого требуется проверка.
//
...
//                          ** Адресат         - ОпределяемыйТип.АдресатЗапретаИзменения - пользователь или УзелИнформационнойБазы
