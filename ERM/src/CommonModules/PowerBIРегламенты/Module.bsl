...
Процедура PowerBIОтправкаДанных_ConsolidatedCollection() Экспорт
	...
	ТЗ.Свернуть("ПериодМесяц, Source, ClientID, Client, CompanyБазовыйЭлемент, BU, Currency, AU, Курс, HOBDocumentTypes, DateCollection, Invoice, CashBatchПредыдущегоМесяца", "Amount, BaseAmount");
