...
Процедура ВыполнитьЗагрузкуДанныхOracleSmith() Экспорт
	...
	Если Не ПолучениеВыполнено Тогда
		...
		РГСофт.ЗарегистрироватьПочтовоеСообщение(Константы.ПолучателиСообщенийОбОшибкахЗагрузкиДанныхOracleSmith.Получить(),
	...
	// 3840
	СтруктураНастроек = Новый Структура();
	ИнициализироватьСтруктуруНастроек(СтруктураНастроек, Перечисления.ТипыСоответствий.OracleSmith, "3840");
...
Процедура ВыполнитьЗагрузкуДанныхLawson() Экспорт
	...
	Если Не ПолучениеВыполнено Тогда
		...
		РГСофт.ЗарегистрироватьПочтовоеСообщение(Константы.ПолучателиСообщенийОбОшибкахЗагрузкиДанныхLawson.Получить(),
...
Процедура ВыполнитьЗагрузкуДанныхHOB_Receivables() Экспорт
	...
	Если Не ПолучениеВыполнено Тогда
		...
		РГСофт.ЗарегистрироватьПочтовоеСообщение(Константы.ПолучателиСообщенийОбОшибкахЗагрузкиДанныхHOB.Получить(),
...
Функция ПолучитьFTPСоединение()
	...
	ПараметрыFTP = РегистрыСведений.НастройкиТранспортаОбмена.НастройкиТранспорта(ПланыОбмена.rgsОбменДокументамиERM.НайтиПоКоду("HB"));
