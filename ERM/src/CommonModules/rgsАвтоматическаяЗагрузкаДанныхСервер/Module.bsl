...
Процедура ЗагрузитьФайлДанныхOracleSmith(ОбрабатываемыйФайл, СтруктураНастроек)
	...
	Иначе
		...
		СформироватьЗадачуОтветственным(СтруктураНастроек.Источник, "Oracle Smith loading error", СтруктураНастроек.СтрокаСообщенияОбОшибкеЖР, ДокументЗагрузки.Ссылка);
