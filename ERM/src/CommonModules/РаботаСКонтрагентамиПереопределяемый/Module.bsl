...
Процедура ПриОпределенииКонтрагентЯвляетсяИностранным(ДанныеКонтрагента, ЯвляетсяИностранным) Экспорт
	...
	Если ТипЗнч(ДанныеКонтрагента.Контрагент) = Тип("СправочникСсылка.Контрагенты")
		И Не ДанныеКонтрагента.Контрагент.Пустая() Тогда
		// Ссылка
		ЯвляетсяИностранным = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(
			ДанныеКонтрагента.Контрагент,
			"СтранаРегистрации") <> Справочники.СтраныМира.Россия;
	ИначеЕсли ТипЗнч(ДанныеКонтрагента.Контрагент) = Тип("СправочникОбъект.Контрагенты") Тогда
		// Объект
		ЯвляетсяИностранным = ДанныеКонтрагента.Контрагент.СтранаРегистрации <> Справочники.СтраныМира.Россия;
