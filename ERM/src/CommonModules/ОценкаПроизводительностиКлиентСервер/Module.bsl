...
// и записывает результат на сервере в <РегистрСведений.УдалитьЗамерыВремени2>
...
// и записывает результат на сервере в <РегистрСУдалитьЗамерыВремениТехнологическиегические>
// Вызывается только с сервера.
//
// Параметры:
//  КлючеваяОперация - 	СправочникСсылка.КлючевыеОперации, Строка - ключевая операция или
...
// Результат замера будет записан в <РегистрСведений.УдалитьЗамерыВремени2>.
//
// Параметры:
//  КлючеваяОперация - СправочникСсылка.КлючевыеОперации, Строка - ключевая операция или
//                     имя ключевой операции.
...
// Результат замера будет записан в <УдалитьЗамерыВремениТехнологическиеиТехнологические>.
//
// Параметры:
//  КлючеваяОперация - СправочникСсылка.КлючевыеОперации, Строка - ключевая операция или
//                                                                 имя ключевой операции.
...
// Может вызываться как с клиента, так и с сервера.
// Результат замера будет записан в регистр сведений УдалитьЗамерыВремени2.
//
// В случае вызова с клиента, заканчивать замер не нужно, время завершения замера зафиксируется
// через глобальный обработчик ожидания ЗакончитьЗамерВремениАвто.
// Возвращает время начала замера.
...
// Может вызываться как с клиента, так и с сервера.
// Результат замера бУдалитьЗамерыВремениТехнологическиений.ЗамерыВремениТехнологические>.
//
// В случае вызова с клиента, заканчивать замер не нужно, время завершения замера зафиксируется
// через глобальный обработчик ожидания <ЗакончитьЗамерВремениАвто>.
