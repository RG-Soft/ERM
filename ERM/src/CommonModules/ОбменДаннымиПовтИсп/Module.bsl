...
// Если план обмена содержит хотя бы один УзелИнформационнойБазы кроме предопределенного,
...
//
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка - УзелИнформационнойБазы плана обмена.
// 
// Возвращаемое значение:
...
// Возвращает список планов обмена, которые содержат хотя бы один УзелИнформационнойБазы обмена (не учитывая ЭтотУзел).
//
...
//
// Параметры:
//  Получатель - ПланОбменаСсылка - ссылка на УзелИнформационнойБазы плана обмена,
...
//  Получатель - ПланОбменаСсылка - ссылка на УзелИнформационнойБазы плана обмена, пользовательский состав которого будет использоваться.
//
// Возвращаемое значение:
...
// Получает предопределенный УзелИнформационнойБазы плана обмена.
//
// Параметры:
//  ИмяПланаОбмена - Строка - имя плана обмена как оно задано в конфигураторе.
// 
// Возвращаемое значение:
//  ЭтотУзел - ПланОбменаСсылка - предопределенный УзелИнформационнойБазы плана обмена.
//
...
// Получает предопределенный УзелИнформационнойБазы плана обмена по ссылке на УзелИнформационнойБазы плана обмена.
//
// Параметры:
//  УзелПланаОбмена - ПланОбменаСсылка - любой УзелИнформационнойБазы плана обмена.
// 
// Возвращаемое значение:
//  ЭтотУзел - ПланОбменаСсылка - предопределенный УзелИнформационнойБазы плана обмена.
//
...
//
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка - УзелИнформационнойБазы плана обмена, для которого требуется получить значение функции.
// 
//  Возвращаемое значение:
//   Истина - УзелИнформационнойБазы принадлежит плану обмена РИБ, иначе Ложь.
//
...
// 
//  Возвращаемое значение:
//   Истина - УзелИнформационнойБазы принадлежит плану обмена стандартного обмена, иначе Ложь.
//
...
// 
//  Возвращаемое значение:
//   Истина - УзелИнформационнойБазы принадлежит плану обмена универсального обмена, иначе Ложь.
//
...
//
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка, ПланОбменаОбъект - УзелИнформационнойБазы плана обмена, для которого требуется получить
//                           значение функции.
// 
//  Возвращаемое значение:
//   Истина - УзелИнформационнойБазы принадлежит плану обмена, использующего функционал БСП, иначе Ложь.
//
...
// 
//  Возвращаемое значение:
//   Истина - УзелИнформационнойБазы принадлежит разделенному плану обмена, использующего функционал БСП, иначе Ложь.
//
...
// 
//  Возвращаемое значение:
//   Истина - УзелИнформационнойБазы принадлежит плану обмена сообщениями, иначе Ложь.
//
...
//
// Параметры:
//  УзелПланаОбмена - ПланОбменаСсылка, ПланОбменаОбъект - УзелИнформационнойБазы плана обмена.
// 
// Возвращаемое значение:
...
//
// Параметры:
//  УзелПланаОбмена - ПланОбменаСсылка - УзелИнформационнойБазы плана обмена, для которого требуется получить менеджер.
// 
...
// 
// Параметры:
//  УзелИнформационнойБазы (обязательный) - ПланОбменаСсылка. УзелИнформационнойБазы плана обмена, для которого необходимо получить
//  внешнее соединение.
...
// 
// Параметры:
// Корреспондент - Структура, ПланОбменаСсылка. УзелИнформационнойБазы плана обмена, который соответствует информационной
//                 базе-корреспонденту.
//
// Возвращаемое значение:
