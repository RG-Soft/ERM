...
Функция ПолучитьЗначениеНастройки(Знач Настройка, ВызыватьИсключение = Истина) Экспорт
	...
	Если ТипЗнч(Настройка) = Тип("Строка") Тогда
		...
		Настройка = ПредопределенноеЗначение("ПланВидовХарактеристик.rgsНастройкиКонфигурации." + ИмяНастройки);
...
Функция ПолучитьПредопределенноеЗначениеПоИмени(ИмяЗначения)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      |	бсбНастройкиКонфигурации.Ссылка КАК Ссылка
	                      |ИЗ
	                      |	ПланВидовХарактеристик.бсбНастройкиКонфигурации КАК бсбНастройкиКонфигурации
	                      |ГДЕ
	                      |	бсбНастройкиКонфигурации.Ссылка = ЗНАЧЕНИЕ(ПланВидовХарактеристик.бсбНастройкиКонфигурации." + ИмяЗначения + ")");
...
Функция ПолучитьЗначениеСохраненнойНастройки(Настройка)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	rgsСохраненныеНастройкиКонфигурации.Значение КАК Значение
	               |ИЗ
	               |	РегистрСведений.rgsСохраненныеНастройкиКонфигурации КАК rgsСохраненныеНастройкиКонфигурации
	               |ГДЕ
	               |	rgsСохраненныеНастройкиКонфигурации.Настройка = &Настройка";
