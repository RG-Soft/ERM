...
Процедура ОтправитьСообщение(Знач УчетнаяЗапись, Знач ПараметрыОтправки) Экспорт
	...
	Если ПараметрыОтправки.Свойство("ПоляЗаголовка") Тогда
		Для Каждого ПолеЗаголовка Из ПараметрыОтправки.ПоляЗаголовка Цикл
			Письмо.УстановитьПолеЗаголовка(ПолеЗаголовка.ИмяПоля, ПолеЗаголовка.ЗначениеПоля, ПолеЗаголовка.СпособКодирования);
		КонецЦикла;
	КонецЕсли;
