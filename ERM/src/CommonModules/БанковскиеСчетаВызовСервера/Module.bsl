...
//   *ИзменениеВалютногоУчетаРазрешено - Булево - прзнак наличия прав на изменение функциональности валютного учета.
//
Функция СведенияОВалютномУчете() Экспорт
	
	Результат = Новый Структура;
	//Результат.Вставить("ВалютныйУчетИспользуется", РаботаСНСИПереопределяемый.ИспользоватьВалютныйУчет());
	//Результат.Вставить("ИзменениеВалютногоУчетаРазрешено", Пользователи.ЭтоПолноправныйПользователь());
