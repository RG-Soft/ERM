...
Процедура ОбработатьОбъектСПерехватомСообщений(Знач Объект, Знач Действие, Знач РежимЗаписи, Знач ПараметрыЗаписи)
	...
	Попытка
		...
		ИначеЕсли Действие = "ПометкаУдаления" Тогда
			// { RGS AGorlenko 1/30/2017 7:15:17 PM - исправлена ошибка при работе с документами
			...
			КонецЕсли;
			// } RGS AGorlenko 1/30/2017 7:16:04 PM - исправлена ошибка при работе с документами
