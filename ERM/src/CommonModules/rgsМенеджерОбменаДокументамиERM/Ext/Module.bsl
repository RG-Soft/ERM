// Конвертация ERM (documents) от 19.12.2016 17:54:03
...
Процедура ДобавитьПКО_Документ_SalesOrder_Получение(ПравилаКонвертации)
	...
	ПравилоКонвертации.ПоляПоиска.Добавить("DocID,Source");
	ПравилоКонвертации.ПоляПоиска.Добавить("Source,Дата,Номер");
	ПравилоКонвертации.ПоляПоиска.Добавить("Source,Номер");
КонецПроцедуры
