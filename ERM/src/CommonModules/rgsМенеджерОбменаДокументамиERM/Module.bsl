// Конвертация ERM (documents) от 13.09.2018 17:31:31
...
Процедура ЗаполнитьПравилаОбработкиДанных(НаправлениеОбмена, ПравилаОбработкиДанных) Экспорт
	Если НаправлениеОбмена = "Получение" Тогда
		...
		ДобавитьПОД_Документ_Memo_Получение(ПравилаОбработкиДанных);
...
КонецПроцедуры
#КонецОбласти
#Область Документ_Memo_Получение
Процедура ДобавитьПОД_Документ_Memo_Получение(ПравилаОбработкиДанных)
	ПравилоОбработки = ПравилаОбработкиДанных.Добавить();
	ПравилоОбработки.Имя = "Документ_Memo_Получение";
	ПравилоОбработки.ОбъектВыборкиФормат = "Документ.Memo";
	ПравилоОбработки.ИспользуемыеПКО.Добавить("Документ_Memo_Получение");
КонецПроцедуры
#КонецОбласти
...
Процедура ЗаполнитьПравилаКонвертацииОбъектов(НаправлениеОбмена, ПравилаКонвертации) Экспорт
	Если НаправлениеОбмена = "Получение" Тогда
		...
		ДобавитьПКО_Документ_Memo_Получение(ПравилаКонвертации);
...
#КонецОбласти
#Область Документ_Memo_Получение
Процедура ДобавитьПКО_Документ_Memo_Получение(ПравилаКонвертации)

	ПравилоКонвертации = ОбменДаннымиXDTOСервер.ИнициализироватьПравилоКонвертацииОбъекта(ПравилаКонвертации);
	ПравилоКонвертации.ИмяПКО = "Документ_Memo_Получение";
	ПравилоКонвертации.ОбъектДанных = Метаданные.Документы.Memo;
	ПравилоКонвертации.ОбъектФормата = "Документ.Memo";
	ПравилоКонвертации.ПравилоДляГруппыСправочника = Ложь;
	...
	НоваяСтрока = ПравилоКонвертации.Свойства.Добавить();
	НоваяСтрока.СвойствоКонфигурации = "BaseAmount";
	НоваяСтрока.СвойствоФормата = "BaseAmount";
	...
	НоваяСтрока = ПравилоКонвертации.Свойства.Добавить();
	НоваяСтрока.СвойствоКонфигурации = "Company";
	НоваяСтрока.СвойствоФормата = "Company";
	
	НоваяСтрока = ПравилоКонвертации.Свойства.Добавить();
	НоваяСтрока.СвойствоКонфигурации = "Currency";
	НоваяСтрока.СвойствоФормата = "Currency";
