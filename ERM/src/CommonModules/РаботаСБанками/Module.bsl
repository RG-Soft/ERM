...
// Получает данные из справочника КлассификаторБанковРФ по значениям БИК и корреспондентского счетаДвоичныеДанныеФайловраметры:
...
//      * ПрикладнаяЗагрузка - Булево - если Истина, знДвоичныеДанныеФайловользует собственный алгоритм загрузки и
//                     ДвоичныеДанныеФайловмодуле менеджераДвоичныеДанныеФайловлены функции.
//
