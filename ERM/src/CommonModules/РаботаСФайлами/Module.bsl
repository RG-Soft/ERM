...
//
//                 - Строка - имя справочника *ДвоичныеДанныеФайлов, отличное
//                            от стандартного <ИмяВладельца>ДвоичныеДанныеФайлов.
//  
// Возвращаемое значение:
...
//
// Параметры:
//  Источник                 - СправочникМенеджер - менеджер справочника с именем "*ДвоичныеДанныеФайлов".
...
Процедура ОпределитьФормуПрисоединенногоФайла(Источник, ВидФормы, Параметры,
	...
	ИначеЕсли ВидФормы = "ФормаСписка" Тогда
		Если Не ЭтоФормаВерсии Тогда
			ВыбраннаяФорма = "Обработка.РаботаСФайлами.Форма.ДвоичныеДанныеФайлов";
			СтандартнаяОбработка = Ложь;
		КонецЕсли;
	КонецЕсли;
...
Процедура ДобавитьПодписьКФайлу(ПрисоединенныйФайл, СвойстваПодписи, ИдентификаторФормы = Неопределено) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.ПроверитьПараметр("ДвоичныеДанныеФайлов.ДобавитьПодписьКФайлу", "ПрисоединенныйФайл", 
...
//
// Параметры:
//  Источник   - СправочникОбъект - объект справочника с именем "*ДвоичныеДанныеФайлов".
