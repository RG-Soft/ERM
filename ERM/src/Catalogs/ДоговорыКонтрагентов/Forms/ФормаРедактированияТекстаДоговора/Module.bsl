...
Процедура Подключаемый_ОбработчикОжиданияПолучитьИЗагрузитьФайлИзХранилища()
	...
	РаботаСФайламиКлиент.ПоместитьПрисоединенныйФайл(ОписаниеОповещения, ДанныеФайла, УникальныйИдентификатор);
...
Процедура ПоместитьФайлВХранилищеИОсвободить(Знач ПрисоединенныйФайл, Знач ИнформацияОФайле)
	...
	// { RGS agorlenko 08.06.2018 19:27:30 - обновление БСП
//	ПрисоединенныеФайлыСлужебный.ПоместитьФайлВХранилищеИОсвободить(
//		ПрисоединенныйФайл, ИнформацияОФайле);
	РаботаСФайламиСлужебныйВызовСервера.СохранитьИзмененияИОсвободитьФайл(
		ПрисоединенныйФайл, ИнформацияОФайле, Истина, "", "");
	// } RGS agorlenko 08.06.2018 19:27:30 - обновление БСП
...
Функция ПодготовитьПараметрыПисьма()
	...
	//СведенияОКонтрагенте = РаботаСНСИПереопределяемый.СведенияОЮрФизЛице(Контрагент, ДатаСреза);
	//
