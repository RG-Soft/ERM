...
Процедура ПроверитьРеквизитыБезДополнительныхДанных(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(Сегмент) И Не (Source <> Перечисления.ТипыСоответствий.OracleMI Или Source <> Перечисления.ТипыСоответствий.OracleSmith) Тогда	
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
...
Процедура ПроверитьРеквизитыСДополнительнымиДанными(Отказ)
	...
	Иначе
		...
		Если Не (Source <> Перечисления.ТипыСоответствий.OracleMI Или Source <> Перечисления.ТипыСоответствий.OracleSmith) Тогда	
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				"""Segment"" is empty!",
