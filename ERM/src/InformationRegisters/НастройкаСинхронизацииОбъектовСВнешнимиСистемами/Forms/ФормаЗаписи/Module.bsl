...
Функция ПроверитьНеобходимостьЗаполненияИНН(СтруктураЗаписи)
	...
	Если СтруктураЗаписи.ТипОбъектаВнешнейСистемы = Перечисления.ТипыОбъектовВнешнихСистем.Client И
		СтруктураЗаписи.ТипСоответствия = Перечисления.ТипыСоответствий.HOBs И НЕ СтруктураЗаписи.ОбъектПриемника.Предопределенный Тогда
