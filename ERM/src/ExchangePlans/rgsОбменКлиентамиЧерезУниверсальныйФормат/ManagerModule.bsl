...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	ВерсииФормата.Вставить("1.2", ОбменКонтрагентамиМенеджерОбменаЧерезУниверсальныйФормат);
...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки) Экспорт
	...
	Иначе
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента", НСтр("ru = 'Обмен клиентами через универсальный формат обмена'"));
	КонецЕсли;
