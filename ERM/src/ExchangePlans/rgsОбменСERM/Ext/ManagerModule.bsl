...
Функция ПодробнаяИнформацияПоОбмену() Экспорт
	Возврат "ПланОбмена.rgsОбменСERM.Форма.ПодробнаяИнформация";
КонецФункции
...
Функция ПолучитьУзелОбменаСERM() Экспорт
	...
	|	rgsОбменСERM.Ссылка
	|ИЗ
	|	ПланОбмена.rgsОбменСERM КАК rgsОбменСERM
	|ГДЕ
...
Процедура ПолучитьВерсииФорматаОбмена(ВерсииФормата) Экспорт
	ВерсииФормата.Вставить("1.0.beta", rgsОбменДаннымиПоInvoiceСERM);
	ВерсииФормата.Вставить("1.0", rgsОбменДаннымиПоInvoiceСERM);
КонецПроцедуры
