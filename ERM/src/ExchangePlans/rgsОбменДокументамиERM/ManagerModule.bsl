...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	Настройки.ФорматОбмена = "http://rg-soft.ru/ERM";
	
	ВерсииФормата = Новый Соответствие;
	ВерсииФормата.Вставить("1.0", rgsМенеджерОбменаДокументамиERM);
...
Функция КраткаяИнформацияПоОбмену(ВариантНастройкиОбмена) Экспорт
	...
	ПоясняющийТекст = "Позволяет выполнять загрузку документов в ERM";
...
Функция ПодробнаяИнформацияПоОбмену(ВариантНастройкиОбмена) Экспорт
	Возврат "ПланОбмена.rgsОбменДокументамиERM.Форма.ПодробнаяИнформация";
КонецФункции
...
//	Получатель - ПланОбменаСсылка - УзелИнформационнойБазы обмена, для которого выполняется проверка параметров учета.
...
//
// Параметры:
//     Получатель - ПланОбменаСсылка - УзелИнформационнойБазы, для которого производится настройка.
...
//
// Параметры:
//     Получатель - ПланОбменаСсылка - УзелИнформационнойБазы, для которого определяется представление отбора.
...
//
// Параметры:
//	Отправитель - ПланОбменаОбъект, Структура - УзелИнформационнойБазы плана обмена, от имени которого выполняется отправка данных.
...
//
// Параметры:
//	Отправитель - ПланОбменаОбъект, Структура - УзелИнформационнойБазы плана обмена, от имени которого выполняется получение данных.
...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки) Экспорт
	...
	Иначе
		Настройки.Вставить("НаименованиеКонфигурацииКорреспондента", НСтр("ru = 'Обмен документами ERM'"));
	КонецЕсли;
...
Функция ПолучитьУзелОбменаСERM() Экспорт
	...
	|ГДЕ
	|	rgsОбменДокументамиERM.Ссылка <> &ЭтотУзел";
	
	Запрос.УстановитьПараметр("ЭтотУзел", ПланыОбмена.rgsОбменДокументамиERM.ЭтотУзел());
...
//
//  Параметры:
// УзелИнформационнойБазы – ПланОбменаСсылка – УзелИнформационнойБазы плана обмена для которого выполняется загрузка данных.
