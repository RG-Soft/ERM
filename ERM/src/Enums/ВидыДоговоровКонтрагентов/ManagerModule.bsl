...
Функция ПолучитьДоступныеЗначения(Отбор, СтрокаПоиска)
	...
	// { RGS AGorlenko 16.05.2016 17:46:34 - 
	...
	// { RGS AGorlenko 16.05.2016 17:46:04 - 
	Исключения.Добавить(Перечисления.ВидыДоговоровКонтрагентов.СПоставщиком);
	// } RGS AGorlenko 16.05.2016 17:46:05 - 
