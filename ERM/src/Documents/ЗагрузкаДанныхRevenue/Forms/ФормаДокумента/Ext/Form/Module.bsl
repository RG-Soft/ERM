...
Процедура ЗаполнитьСтруктуруКолонокПоУмолчаниюOracleMI()
	...
	// { RGS AGorlenko 14.12.2015 15:59:28 - для MI нет
	//// Sub Sub Segment
	//СтрокаТЗ = СтруктураКолонок.Добавить();
	//СтрокаТЗ.ИмяПоля = "SubSubSegment";
	//СтрокаТЗ.ИмяКолонки = "Sub Sub Segment";
	...
	//СтрокаТЗ.ИмяКолонки = "Sub Segment";
	//СтрокаТЗ.НомерКолонки = 3;
	// } RGS AGorlenko 14.12.2015 15:59:35 - для MI нет
...
Процедура ТипВнешнейСистемыПриИзменении(Элемент)
	ИзменениеВидимостиКолонок();
КонецПроцедуры

// { RGS PMatkov 15.12.2015 17:10:56
&НаКлиенте
Процедура ИзменениеВидимостиКолонок()
		Если Элементы.ТипВнешнейСистемы.ТекстРедактирования = "Lawson" Тогда
	...
	ИначеЕсли Элементы.ТипВнешнейСистемы.ТекстРедактирования = "Oracle (MI)" Тогда
