...
Процедура ЗаполнитьСтруктуруКолонокПоУмолчанию()
	...
	// TRX_NUMBER
	СтрокаТЗ = СтруктураКолонок.Добавить();
	СтрокаТЗ.ИмяПоля = "TRX_NUMBER";
	СтрокаТЗ.ИмяКолонки = "TRX_NUMBER";
	
	// AR_INVOICE_NUMBER
	СтрокаТЗ = СтруктураКолонок.Добавить();
	СтрокаТЗ.ИмяПоля = "AR_INVOICE_NUMBER";
	СтрокаТЗ.ИмяКолонки = "AR_INVOICE_NUMBER";
	...
	// BILL_ID
	СтрокаТЗ = СтруктураКолонок.Добавить();
	СтрокаТЗ.ИмяПоля = "BILL_ID";
	СтрокаТЗ.ИмяКолонки = "BILL_ID";
	
	// SHIP_ID
	СтрокаТЗ = СтруктураКолонок.Добавить();
	СтрокаТЗ.ИмяПоля = "SHIP_ID";
	СтрокаТЗ.ИмяКолонки = "SHIP_ID";
