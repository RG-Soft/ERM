...
Процедура СформироватьПроводкиDSS(СтруктураПараметров, АдресХранилища) Экспорт
	...
	КэшCashBatch.Индексы.Добавить("Client");
	КэшCashBatch.Индексы.Добавить("Account");
	КэшCashBatch.Индексы.Добавить("Currency");
	
	КэшBatchAllocation = РезультатЗапроса[12].Выгрузить();
	КэшBatchAllocation.Индексы.Добавить("Client");
	КэшBatchAllocation.Индексы.Добавить("Account");
	КэшBatchAllocation.Индексы.Добавить("Currency");
