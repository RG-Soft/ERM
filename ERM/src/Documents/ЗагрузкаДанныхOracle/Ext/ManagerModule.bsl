...
Процедура СформироватьПроводкиDSS(СтруктураПараметров, АдресХранилища) Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.Транзакция) Тогда
			...
			//Продолжить;
			Если ВыборкаДетальныеЗаписи.Транзакция.Client  = Справочники.Контрагенты.Unreconciled и ВыборкаДетальныеЗаписи.Client <> Справочники.Контрагенты.Unreconciled Тогда
