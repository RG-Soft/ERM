...
Процедура СформироватьПроводкиDSSSmith___0(СтруктураПараметров, АдресХранилища)
...
КонецФункции
Функция ПолучитьМассивТранзакцийOracleSmithПоID_ORIG(СтруктураПараметров)
	...
	|ГДЕ
	|	ТранзакцияOracle.Номер В(&Номер)";
	
	Префикс = "SM-";
	Запрос.УстановитьПараметр("Номер", Префикс + СтруктураПараметров.ID_ORIG);
...
// Настройки_синхронизации (Check conflicts)
///////////////////////////////////////////////////////////////////////////////
#Область Настройки_синхронизации
#КонецОбласти

///////////////////////////////////////////////////////////////////////////////
// Провести загруженные документы
///////////////////////////////////////////////////////////////////////////////
#Область Провести_загруженные_документы
