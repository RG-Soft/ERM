...
Процедура СоздатьНовыйОбъекты(Отказ)
	...
	Для каждого ТекСтрокаТЧ Из НовыеBillingКлиенты Цикл
		...
		// Lawson
		ОбъектЕстьВРегистре = РегистрыСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектЕстьВРегистре(ТекСтрокаТЧ.LawsonID
		...
		// MI
		ОбъектЕстьВРегистре = РегистрыСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектЕстьВРегистре(ТекСтрокаТЧ.MIID
		...
		// SMITH
		ОбъектЕстьВРегистре = РегистрыСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектЕстьВРегистре(ТекСтрокаТЧ.SMITHID
...
Процедура ОбработатьИзмененныеОбъекты(Отказ)
	...
	Для каждого ТекСтрокаТЧ Из ИзмененныеBillingID Цикл
		...
		// Lawson
		ОбъектЕстьВРегистре = РегистрыСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектЕстьВРегистре(ТекСтрокаТЧ.NewLawsonID
			, Перечисления.ТипыСоответствий.Lawson
			, Перечисления.ТипыОбъектовВнешнихСистем.Client);
		...
		// MI
		ОбъектЕстьВРегистре = РегистрыСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектЕстьВРегистре(ТекСтрокаТЧ.NewMIID
			, Перечисления.ТипыСоответствий.OracleMI
			, Перечисления.ТипыОбъектовВнешнихСистем.Client);
		...
		// Smith
		ОбъектЕстьВРегистре = РегистрыСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектЕстьВРегистре(ТекСтрокаТЧ.NewSmithID
			, Перечисления.ТипыСоответствий.OracleSmith
			, Перечисления.ТипыОбъектовВнешнихСистем.Client);
...
Процедура ДеактивироватьОтсутствующихКлиентов(Отказ)
	...
	Для каждого СтрокаТЧ Из ОтсутствующиеКлиенты Цикл
