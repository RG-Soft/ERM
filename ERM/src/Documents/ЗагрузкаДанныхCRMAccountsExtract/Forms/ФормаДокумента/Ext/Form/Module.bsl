...
Процедура ПрочитатьФайл(Команда)
	...
	Объект.ОтсутствующиеКлиенты.Очистить();
...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	Если СтруктураДанных.Свойство("ТаблицаОтсутствующиеКлиенты") Тогда
		Объект.ОтсутствующиеКлиенты.Загрузить(СтруктураДанных.ТаблицаОтсутствующиеКлиенты);
		Модифицированность = Истина;
	КонецЕсли;
...
Процедура ЗаполнитьСтруктуруКолонокПоУмолчанию()
	...
	СтрокаТЗ.ИмяКолонки = "Corporate Account Id";
	...
	// SAP Sync Flag
	СтрокаТЗ = СтруктураКолонок.Добавить();
	СтрокаТЗ.ИмяПоля = "SAPSynchFlag";
	СтрокаТЗ.ИмяКолонки = "SAP Synch Flag";
