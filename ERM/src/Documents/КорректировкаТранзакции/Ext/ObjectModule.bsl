...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если РеквизитыТранзакции.ТранзакцияAmount <> ДетализацияПоКлиенту.Итог("Amount") ИЛИ РеквизитыТранзакции.ТранзакцияBaseAmount <> ДетализацияПоКлиенту.Итог("BaseAmount") Тогда
		Отказ = Истина;
