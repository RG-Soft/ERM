...
Функция НайтиСоздатьJV(Клиент, ДатаКорректировки, Отказ)
	...
	Иначе
		...
		Запрос.Текст = 
			...
			|ПОМЕСТИТЬ КлиентИзMapping
			|ИЗ
			|	РегистрСведений.НастройкаСинхронизацииОбъектовСВнешнимиСистемами КАК НастройкаСинхронизацииОбъектовСВнешнимиСистемами
			|ГДЕ
			|	НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ТипСоответствия = &ТипСоответствия
			|	И НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектПриемника = &ОбъектПриемника
			|
			|СГРУППИРОВАТЬ ПО
			|	НастройкаСинхронизацииОбъектовСВнешнимиСистемами.Идентификатор,
			|	НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектПриемника,
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	КлиентИзMapping.Идентификатор,
			|	КлиентИзMapping.Период,
			|	КлиентИзMapping.ОбъектПриемника
			|ИЗ
			|	КлиентИзMapping КАК КлиентИзMapping
			...
			|		ПО КлиентИзMapping.Идентификатор = НастройкаСинхронизацииОбъектовСВнешнимиСистемами.Идентификатор
			|			И КлиентИзMapping.Период = НастройкаСинхронизацииОбъектовСВнешнимиСистемами.Период
			|			И КлиентИзMapping.ОбъектПриемника = НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектПриемника
			|			И КлиентИзMapping.ТипСоответствия = НастройкаСинхронизацииОбъектовСВнешнимиСистемами.Идентификатор";
...
Процедура ПроверитьMappingКлиентов(Отказ, Source)
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ОбъектПриемника КАК Клиент,
		|	СУММА(ВЫБОР
		|			КОГДА НастройкаСинхронизацииОбъектовСВнешнимиСистемами.ТипСоответствия = &Source
		|				ТОГДА 1
		|			ИНАЧЕ 0
