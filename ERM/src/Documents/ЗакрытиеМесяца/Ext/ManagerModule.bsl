...
Процедура ПолучитьДанныеRevenue(СтруктураПараметров, ТаблицаКоллизий, ТаблицаРасхождений)
		...
		Запрос.Текст = 
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	RevenueОбороты.Account.БазовыйЭлемент.Родитель.Родитель КАК AccountБазовыйЭлементРодитель,
			|	RevenueОбороты.AU.Сегмент.БазовыйЭлемент КАК SubSubSegmentБазовыйЭлементРодительРодитель,
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	ВТ_ОборотыЕРМ.AccountБазовыйЭлементРодитель КАК AccountБазовыйЭлементРодитель,
			|	ВТ_ОборотыЕРМ.SubSubSegmentБазовыйЭлементРодительРодитель КАК Segment,
			...
			|
			|СГРУППИРОВАТЬ ПО
			|	ВТ_ОборотыЕРМ.AccountБазовыйЭлементРодитель,
			|	ВТ_ОборотыЕРМ.SubSubSegmentБазовыйЭлементРодительРодитель,
			...
			|	ЕСТЬNULL(ВТ_ОстаткиHFM.СсылкаAccount, ВТ_ОборотыЕРМ_Группировка.AccountБазовыйЭлементРодитель) КАК Account
			|ИЗ
			...
			|			И (ВТ_ОстаткиHFM.СсылкаAccount = ВТ_ОборотыЕРМ_Группировка.AccountБазовыйЭлементРодитель)";
