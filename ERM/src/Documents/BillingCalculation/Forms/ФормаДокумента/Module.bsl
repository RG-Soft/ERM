...
Процедура Заполнить(Команда)
	...
	СтруктураПоиска = Новый Структура("ManualAdjustment", Ложь);
	Если Объект.LawsonBilling.НайтиСтроки(СтруктураПоиска).Количество() > 0
		ИЛИ Объект.HOBBilling.НайтиСтроки(СтруктураПоиска).Количество() > 0
		ИЛИ Объект.OracleMIBilling.НайтиСтроки(СтруктураПоиска).Количество() > 0
		ИЛИ Объект.OracleSmithBilling.НайтиСтроки(СтруктураПоиска).Количество() > 0
		ИЛИ Объект.RadiusBilling.НайтиСтроки(СтруктураПоиска).Количество() > 0 Тогда
