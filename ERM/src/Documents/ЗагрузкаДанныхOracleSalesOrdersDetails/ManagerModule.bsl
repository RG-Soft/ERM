...
Процедура ОбновитьРеквизитыSalesOrders(СтруктураПараметров, АдресХранилища) Экспорт
	...
	// { RGS TAlmazova 22.03.2018 16:52:08 - Суммы инвойсов заполняются загрузкой оборотов, инвойс нужен для DIR
	...
	|	ИсходникиСсылки.FirstSubmissionDate,
	|	ИсходникиСсылки.ApprovalDate,
	// { RGS TAlmazova 22.03.2018 16:52:24 - Суммы инвойсов заполняются загрузкой оборотов, инвойс нужен для DIR
	|	ИсходникиСсылки.СсылкаInvoice,
