...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РольДоступна("ReadOnly") И Не РольДоступна("ПолныеПрава") Тогда
		...
		Элементы.ОбновитьSalesOrders.Доступность = Ложь;
	КонецЕсли;
	//RGS VSobolev S-E-0000786 15.03.2019
...
Процедура ЗагрузитьСтруктуруКолонок(Источник)
	...
	СтруктураКолонок.Загрузить(Документы.ЗагрузкаДанныхOracleSalesOrdersDetails.ПолучитьСтруктуруКолонокТаблицыДанных());
