								...
								Пока ВыборкаLegalEntity.Следующий() Цикл
									...
									Пока ВыборкаClientID.Следующий() Цикл
										...
										Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
											...
											КонецЕсли;
											ЗаполнитьСтрокуДанныхПоШтрафам(ДанныеПоШтрафам, ВыборкаДетальныеЗаписи, НачалоПериодаРасчета, 
												ТекКонецПериодаРасчета, ТекущийБаланс, КэшКурсов, ЕстьПроблема ИЛИ ВыборкаДетальныеЗаписи.ЕстьПроблемаРасчета,
												ОписаниеПроблемы);
										...
										ВыборкаДетальныеЗаписи.Следующий();
										ЗаполнитьСтрокуДанныхПоШтрафам(ДанныеПоШтрафам, ВыборкаДетальныеЗаписи, НачалоПериодаРасчета, 
											КонецПериодаРасчета, ТекущийБаланс, КэшКурсов, ЕстьПроблема ИЛИ ВыборкаДетальныеЗаписи.ЕстьПроблемаРасчета,
											ОписаниеПроблемы);
...
Процедура ЗаполнитьСтрокуДанныхПоШтрафам(ДанныеПоШтрафам, Параметры, НачалоПериодаРасчета, КонецПериодаРасчета, Баланс, 
	КэшКурсов, ЕстьПроблема, ОписаниеПроблемы)
	...
	ЗаполнитьЗначенияСвойств(СтрокаШтрафа, Параметры, "Source, Company, LegalEntity, AU, ClientID, Client, Contract, Invoice, DueDate, Currency, Percent");
