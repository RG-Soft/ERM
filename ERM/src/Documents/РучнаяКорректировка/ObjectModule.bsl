...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("СтарыеЗначенияКлючей") Тогда
		...
		Если Source = Перечисления.ТипыСоответствий.Lawson ИЛИ Source = Перечисления.ТипыСоответствий.HOBs ИЛИ Source = Перечисления.ТипыСоответствий.OracleMI Тогда
