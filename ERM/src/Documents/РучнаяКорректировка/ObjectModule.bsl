...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("СтарыеЗначенияКлючей") Тогда
		...
		Если Source = Перечисления.ТипыСоответствий.Lawson ИЛИ Source = Перечисления.ТипыСоответствий.HOBs ИЛИ Source = Перечисления.ТипыСоответствий.OracleMI ИЛИ Source = Перечисления.ТипыСоответствий.OracleSmith Тогда
			
			Если СтарыеЗначенияКлючей.Source <> Source ИЛИ СтарыеЗначенияКлючей.Company <> Company
				ИЛИ СтарыеЗначенияКлючей.JournalLawson <> JournalLawson 
				ИЛИ (Source <> Перечисления.ТипыСоответствий.OracleMI И СтарыеЗначенияКлючей.LineNbrLawson <> LineNbrLawson) 
				ИЛИ СтарыеЗначенияКлючей.Дата <> Дата Тогда
				...
				НЗ.Отбор.Journal.Установить(СтарыеЗначенияКлючей.JournalLawson);
				Если Source <> Перечисления.ТипыСоответствий.OracleMI И Source <> Перечисления.ТипыСоответствий.OracleSmith Тогда
					НЗ.Отбор.LineNbr.Установить(СтарыеЗначенияКлючей.LineNbrLawson);
				КонецЕсли;
				НЗ.Отбор.Date.Установить(СтарыеЗначенияКлючей.Дата);
				НЗ.Записать(Истина);
