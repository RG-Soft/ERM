	...
	Иначе
		...
		ИначеЕсли Реквизиты.TransactionType = Перечисления.HOBTransactionType.Receivables Тогда
			...
			ИначеЕсли Реквизиты.HOBInvoiceType = Перечисления.HOBDocumentTypes.АктОбОказанииПроизводственныхУслуг
				...
				Если (Реквизиты.HOBDocumentType = Перечисления.HOBDocumentTypes.Сторно И Реквизиты.HOBReverseType = Перечисления.HOBDocumentTypes.КорректировкаДолга) ИЛИ Реквизиты.HOBDocumentType = Перечисления.HOBDocumentTypes.КорректировкаДолга Тогда 
