...
Процедура ВыполнитьДвижениеRevenue(Реквизиты, СвязанныеДокументы, Движения, Сумма, СуммаФВ, Отказ)
	...
	Если ЗначениеЗаполнено(Реквизиты.EndClient) Тогда
		...
		Если НЕ ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Реквизиты.EndClient, "Предопределенный") Тогда
...
Функция ФормироватьДвижениеInvoicedDebtsПоSO(Реквизиты)
	...
	Возврат  РегистрыСведений.ДатыDIRИзГИС.ЗаписьЕстьВРегистре(Реквизиты);
