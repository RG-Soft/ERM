...
//		КонецЕсли;
		...
		Если (Реквизиты.TransactionType = Перечисления.HOBTransactionType.Accrual И
			ЗначениеЗаполнено(Реквизиты.SalesOrderID) ИЛИ
			Реквизиты.TransactionType = Перечисления.HOBTransactionType.Receivables И
			ЗначениеЗаполнено(Реквизиты.InvoiceID)) И
			...
			ВыполнитьДействияПодсистемыDIR(Реквизиты, ПараметрыПроведения.СвязанныеДокументы, Движения, СуммыДляПроводки.Amount, СуммыДляПроводки.BaseAmount, Отказ);
...
Процедура ВыполнитьДействияПодсистемыDIR(Реквизиты, СвязанныеДокументы, Движения, Сумма, СуммаUSD, Отказ)
