...
Процедура ДозаполнитьИнвойсИзПроводки(Инвойс, ПроводкаDSSОбъект)
	...
	РеквизитыИнвойса = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Инвойс, "Company,Номер,Client,Location,SubSubSegment,AU,Account,Currency,Amount,ClientID");
	...
	Если НЕ ЗначениеЗаполнено(РеквизитыИнвойса.Company) ИЛИ НЕ ЗначениеЗаполнено(РеквизитыИнвойса.Номер) ИЛИ НЕ ЗначениеЗаполнено(РеквизитыИнвойса.Client) 
		...
		Для каждого Реквизит из РеквизитыИнвойса Цикл
			Если Реквизит.Ключ <> "Номер" И Реквизит.Ключ <> "Client" И Реквизит.Ключ <> "Account" И Реквизит.Ключ <> "Amount" И Реквизит.Ключ <> "ClientID" Тогда
