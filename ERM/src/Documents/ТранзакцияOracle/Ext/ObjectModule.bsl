	...
	Если Реквизиты.Amount <> 0 или Реквизиты.BaseAmount <> 0 Тогда
		...
		ИначеЕсли Реквизиты.GlSourceType = Перечисления.OracleGlSourceType.Receivables Тогда
			...
			ИначеЕсли Реквизиты.DocType = "CASH"
				...
				ВыполнитьДвижениеPayments(Реквизиты, ПараметрыПроведения.СвязанныеДокументы, Движения, -Реквизиты.Amount, Отказ);
				// } RGS TAlmazova 22.08.2016 9:41:52 - отражение в регистре Payments
				
			ИначеЕсли Реквизиты.DocType = "CASH"
				И (Реквизиты.TransType = "CCURR_REC" ИЛИ Реквизиты.TransType = "TRADE_REC") Тогда // разнесение платежей
			...
			ИначеЕсли Реквизиты.DocType = "CM" И Реквизиты.TransType = "CM_REC" ИЛИ Реквизиты.DocType = "DM" И Реквизиты.TransType = "DM_REC" Тогда
			...
			ИначеЕсли Реквизиты.DocType = "CM" И Реквизиты.TransType = "CMAPP_REC" Тогда
...
Процедура ВыполнитьДвижениеPayments(Реквизиты, СвязанныеДокументы, Движения, Сумма, Отказ)
