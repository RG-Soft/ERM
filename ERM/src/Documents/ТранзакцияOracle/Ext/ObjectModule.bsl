	...
	Если Реквизиты.Amount <> 0 или Реквизиты.BaseAmount <> 0 Тогда
		...
		ИначеЕсли Реквизиты.GlSourceType = Перечисления.OracleGlSourceType.Receivables Тогда
			...
			ИначеЕсли Реквизиты.DocType = "CASH"
				...
				ВыполнитьДвижениеPayments(Реквизиты, ПараметрыПроведения.СвязанныеДокументы.CashBatch, Движения, -Реквизиты.Amount, Отказ);
...
Процедура ВыполнитьДвижениеPayments(Реквизиты, Invoice, Движения, Сумма, Отказ)
