...
Процедура ЗаполнитьДатыВDIR_MI(Invoice)
	...
	Даты = Новый Соответствие();
 	...
 	ОтчетныйПериод_ДатаОкончания = Invoice.ОтчетныйПериод_ДатаОкончания;
 	 
 	Если ЗначениеЗаполнено(ОтчетныйПериод_ДатаОкончания) И Invoice.Дата >= Дата(2020, 1, 1) Тогда
