...
Функция ВыполнитьПроверкуНастроекСинхронизации(ТаблицаДанных)
	...
	|	ПОДСТРОКА(ТаблицаИсходныхДанных.GL_ACCOUNT, 17, 4) + ПОДСТРОКА(ТаблицаИсходныхДанных.GL_ACCOUNT, 22, 3) КАК Account,
...
Процедура СформироватьПроводкиDSSMI(ТаблицаДанных)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ЗаполнитьТранзакцию(ТранзакцияOracleОбъект, ВыборкаДетальныеЗаписи, ТипВнешнейСистемы, Отказ, ТекстСообщенияОбОшибках, НомерДокумента);
...
Процедура СформироватьПроводкиDSSSmith(ТаблицаДанных)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ЗаполнитьТранзакцию(ТранзакцияOracleОбъект, ВыборкаДетальныеЗаписи, ТипВнешнейСистемы, Отказ, ТекстСообщенияОбОшибках);
...
&НаСервере
Процедура ЗаполнитьТранзакцию(ТранзакцияOracleОбъект, ДанныеДляЗаполнения, Source, Отказ, ТекстСообщенияОбОшибках, НомерДокумента = Ложь)
