...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.Пользователь) 
		И ПроверитьПользователяНаВалидностьВМС() Тогда
...
&НаСервере
Функция ПроверитьПользователяНаВалидностьВМС()
...
Процедура РаботаСНастройкамиКнопка()
	...
	Если Элементы.ГруппаНастройкиИКопирование.ТекущаяСтраница = Элементы.ГруппаРаботСНастройками Тогда 
		Элементы.ГруппаНастройкиИКопирование.ТекущаяСтраница = Элементы.ГруппаОсновныеНастройки;
		Элементы.ГруппаРаботСНастройками.Видимость = Ложь;
	Иначе
		Элементы.ГруппаНастройкиИКопирование.ТекущаяСтраница = Элементы.ГруппаРаботСНастройками;
		Элементы.ГруппаРаботСНастройками.Видимость = Истина;
