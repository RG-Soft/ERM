...
Процедура ЗаполнитьБазовыйЭлементLocations(ПодразделениеОрганизации, СтруктураAU, ТЗДанныеHFM_Locations)
		...
		СтрокаHFM_Locations = ТЗДанныеHFM_Locations.Найти(СтруктураAU.SubGeomarket , "Код");
		...
		Если СтрокаHFM_Locations <> Неопределено И РеквизитыПодразделениеОрганизации.БазовыйЭлемент <> СтрокаHFM_Locations.Ссылка Тогда
