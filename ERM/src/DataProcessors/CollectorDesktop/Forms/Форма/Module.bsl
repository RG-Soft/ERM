...
Процедура ForecastDateПриИзменении(Элемент)
	...
	ГруппаОтбораИ = ОтборыСписковКлиентСервер.СоздатьГруппуЭлементовОтбора(Invoices.Отбор.Элементы, "Группа И ForecastDate",
		ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ);
	ОтборыСписковКлиентСервер.УстановитьЭлементОтбораКоллекции(ГруппаОтбораИ.Элементы, "ForecastDate", НачалоДня(ForecastDate.ДатаНачала),
		ВидСравненияКомпоновкиДанных.БольшеИлиРавно);
	ОтборыСписковКлиентСервер.УстановитьЭлементОтбораКоллекции(ГруппаОтбораИ.Элементы, "ForecastDate", КонецДня(ForecastDate.ДатаОкончания),
...
Процедура FiscalInvDateПриИзменении(Элемент)
	...
	ГруппаОтбораИ = ОтборыСписковКлиентСервер.СоздатьГруппуЭлементовОтбора(Invoices.Отбор.Элементы, "Группа И FiscalInvDate",
		ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ);
	ОтборыСписковКлиентСервер.УстановитьЭлементОтбораКоллекции(ГруппаОтбораИ.Элементы, "FiscalInvDateНачалоДня", НачалоДня(FiscalInvDate.ДатаНачала),
		ВидСравненияКомпоновкиДанных.БольшеИлиРавно);
	ОтборыСписковКлиентСервер.УстановитьЭлементОтбораКоллекции(ГруппаОтбораИ.Элементы, "FiscalInvDateНачалоДня", КонецДня(FiscalInvDate.ДатаОкончания),
		ВидСравненияКомпоновкиДанных.МеньшеИлиРавно);
...
Процедура InvoiceDateПриИзменении(Элемент)
	...
	ГруппаОтбораИ = ОтборыСписковКлиентСервер.СоздатьГруппуЭлементовОтбора(Invoices.Отбор.Элементы, "Группа И",
		ТипГруппыЭлементовОтбораКомпоновкиДанных.ГруппаИ);
	ОтборыСписковКлиентСервер.УстановитьЭлементОтбораКоллекции(ГруппаОтбораИ.Элементы, "InvDateНачалоДня", НачалоДня(InvoiceDate.ДатаНачала),
		ВидСравненияКомпоновкиДанных.БольшеИлиРавно);
	ОтборыСписковКлиентСервер.УстановитьЭлементОтбораКоллекции(ГруппаОтбораИ.Элементы, "InvDateНачалоДня", КонецДня(InvoiceDate.ДатаОкончания),
		ВидСравненияКомпоновкиДанных.МеньшеИлиРавно);
