...
Процедура ForecastDateПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Invoices, "ForecastDate", ForecastDate, , , ЗначениеЗаполнено(ForecastDate));
...
Процедура FiscalInvDateПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Invoices, "FiscalInvDate", FiscalInvDate, , , ЗначениеЗаполнено(FiscalInvDate));
...
Процедура InvoiceDateПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Invoices, "InvDate", InvoiceDate, , , ЗначениеЗаполнено(InvoiceDate));
...
&НаКлиенте
Процедура CustUserNameПриИзменении(Элемент)
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Invoices, "CustUName", CustUserName, , , ЗначениеЗаполнено(CustUserName));
...
Процедура RWDTargetDateПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Invoices, "RWDTargetDate", КонецДня(ТекущаяДата()), ВидСравненияКомпоновкиДанных.МеньшеИлиРавно , ,RWDTargetDate);
