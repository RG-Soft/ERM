...
Процедура ОбновитьБазовыеЭлементы(ТаблицаДанных)
	...
	|				ИЛИ Сегменты.Source = ЗНАЧЕНИЕ(Перечисление.ТипыСоответствий.OracleSmith))
	...
	|				ИЛИ ПодразделенияОрганизаций.Source = ЗНАЧЕНИЕ(Перечисление.ТипыСоответствий.OracleSmith))
