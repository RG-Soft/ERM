...
//
//  Параметры:
//      УзелОбмена - ПланОбменаСсылка - УзелИнформационнойБазы обмена для возвращаемых настроек. Если не указано, то используется 
	...
	Для Каждого Строка Из ТаблицаМетаданныхСоставаУзла Цикл
		...
		Если ЭлементыНабораИзменения.Найти(ИмяНабора) = Неопределено Тогда
			...
			Набор.Запрос = "
				...
				|ГДЕ " + ИмяНабора + "_Изменения.УзелИнформационнойБазы = &УзелИнформационнойБазы
				|";
		КонецЕсли;
...
//
//  Параметры:
//      УзелОбмена - ПланОбменаСсылка - ссылка на УзелИнформационнойБазы обмена для возвращаемых настроек. Если не указано, то
