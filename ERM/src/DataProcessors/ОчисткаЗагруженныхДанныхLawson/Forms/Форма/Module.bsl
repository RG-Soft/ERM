...
Процедура ОчиститьРегистрыНаСервере()
	...
	Иначе
		...
		МассивИменМетаданных.Добавить("Документ.ПроводкаDSS");
		...
		МассивИменМетаданных.Добавить("РегистрСведений.КлючиSalesOrders");
		...
		МассивИменМетаданных.Добавить("РегистрСведений.КлючиMemo");
		...
		//Проводки DSS
		СтрокаDSS = СтруктураБД.Найти("Документ.ПроводкаDSS", "ИмяТаблицы");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"#ИмяТаблицыDSS#",СтрокаDSS.ИмяТаблицыХранения);
		...
		//КлючиSalesOrders
		СтрокаКлючиSalesOrders = СтруктураБД.Найти("РегистрСведений.КлючиSalesOrders", "ИмяТаблицы");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"#ИмяТаблицы_КлючиSalesOrders#",СтрокаКлючиSalesOrders.ИмяТаблицыХранения);
		...
		//КлючиMemo
		СтрокаКлючиMemo = СтруктураБД.Найти("РегистрСведений.КлючиMemo", "ИмяТаблицы");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"#ИмяТаблицы_КлючиMemo#",СтрокаКлючиMemo.ИмяТаблицыХранения);
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"#ИмяБазы",ИмяБазы);
