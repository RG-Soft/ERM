...
Процедура СоздатьЗаписиРегистра(ТаблицаДанных)
	...
	|	RadiusSubSubSegment.Значение КАК SubSubSegment,
	|	RadiusLocation.Значение КАК Location
	|ИЗ
	|	врТЗТаблицаДанных КАК врТЗТаблицаДанных
	...
	СтруктураПоискаJV = Новый Структура("Company, Client, Location, SubSubSegment, Account, Currency");
