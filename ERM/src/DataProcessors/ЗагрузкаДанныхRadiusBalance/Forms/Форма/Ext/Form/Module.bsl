...
Процедура СоздатьЗаписиРегистра(ТаблицаДанных)
	...
	|		ПО врТЗТаблицаДанных.Invoice = КлючиSalesOrders.ArInvoice
	...
	Пока ВыборкаДанные.Следующий() Цикл
		...
		Если ВыборкаДанные.TransType = "I" Тогда
			...
			СтрокаКэша = КэшИнвойсов.Найти(ВыборкаДанные.Invoice, "ArInvoice");
...
Функция СоздатьИнвойс(ДанныеДляЗаполнения)
	...
	ДокОбъект.Номер = ДанныеДляЗаполнения.Invoice;
