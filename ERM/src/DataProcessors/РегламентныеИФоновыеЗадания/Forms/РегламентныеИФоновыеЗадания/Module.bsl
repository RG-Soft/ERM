...
Процедура УстановитьУсловноеОформление()
	...
	Если Параметры.Свойство("ОтображаемыеЗадания") Тогда
		Элемент = УсловноеОформление.Элементы.Добавить();
		ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
		ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.Использование.Имя);
		ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
		...
		ОтображаемыеЗадания = Новый СписокЗначений;
		ОтображаемыеЗадания.ЗагрузитьЗначения(Параметры.ОтображаемыеЗадания);
		ОтборЭлемента.ПравоеЗначение = ОтображаемыеЗадания;
		Элемент.Оформление.УстановитьЗначениеПараметра("Видимость", Ложь);
	КонецЕсли;
