...
&НаКлиенте
Процедура SalesOrderПриИзменении(Элемент)
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(SalesOrders, "SalesOrder", SalesOrder, , , ЗначениеЗаполнено(SalesOrder));
